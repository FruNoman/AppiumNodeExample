...
//                        .createAvd(
//                                new File(avdManager.getBaseAvdFolder().getAbsolutePath() + File.separator + "avd_" + new Date().getTime()),
//                                "test_device",
//                                currentSystemImage,
//                                new File(ANDROID_HOME+File.separator+"skins"),
//                                "pixel_2",
//                                "512M",
//                                hardwareProperties,
//                                bootConfig,
...
//        }
        ...
        appiumCapabilities.setCapability(MobileCapabilityType.APP,PROJECT_DIR+File.separator+"src"+File.separator+"main"+File.separator+"resources"+File.separator+"app-debug.apk");
        ...
        driver = new AndroidDriver<MobileElement>(new URL("http://172.22.89.63:4444/wd/hub"), appiumCapabilities);
